...
/**
 * Generate a JWT for reseting password a user.
 * @param {number} userId - User's ID.
 * @returns {string} - Signed JWT.
 */
const generateTokenToResetPassword = (userId) => {
    try {
...
module.exports = { generateToken, createResponse, generateTokenToResetPassword };